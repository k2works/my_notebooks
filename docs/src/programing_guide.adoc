...
- Combine Function into Class(144)
- Combine Function into Transform(149)
...
- Replace Condition with Polymorphism(272)
...
- Replace Subclass with Delegate(399)
...
==== 臭うコード2nd
* Alternative Classes with Different Interface(83)
** Change Function Declaration(124)
** Move Function(198)
** Extract Superclass(375)
* Comments(84)
